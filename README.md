...
> Auto localstorage wrapper with expiry

[![npm version](https://badge.fury.io/js/auto-local-storage.svg)](https://www.npmjs.com/package/auto-local-storage)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install auto-local-storage
```

## Quick Start

```javascript
const { storage } = require('auto-local-storage');
...
```javascript
const { storage, batch } = require('auto-local-storage');
